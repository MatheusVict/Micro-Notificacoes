const HTML_NOTIFICATION_ADVERSARY = `
        ...
        <div style="background: white; border-radius: 3px;">              
            <div style="padding: 56px 48px 72px 48px;">
                ...
                <p style="margin: 0; margin-bottom: 56px; font-weight: 400; color: #979e97; font-size: 18px;">
                    Você foi desafiado por #NOME_SOLICITANTE! <br/>
                    Para maiores informações, acesse seu aplicativo.
                </p>
            </div>
        </div>
...
export default HTML_NOTIFICATION_ADVERSARY;
